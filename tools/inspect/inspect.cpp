...
const char* pika_no_inspect = "pika-"
                              "no-inspect";
...
namespace {
        ...
        const string& content, const inspector_list& insp_list)
    {
        ...
        {
            itr->inspector->inspect(
                lib, pth);    // always call two-argument form
...
int cpp_main(int argc_param, char* argv_param[])
{
    ...
    desc_commandline.add_options()("help,h", "print some command line help")(
        "output,o", value<std::string>(),
        "the filename to write the output to (default: stdout)")(
        "text,t", "write a text file (default: html)")("brief,b",
        "write a short report only (default: comprehensive)")("limit,l",
        value<std::size_t>(),
        "set limit to the length check tool (default: 90)")

        ("license",
            value<bool>(&license_ck)->implicit_value(true)->zero_tokens(),
            "check for Boost license violations (default: off)")("spdx_license",
            value<bool>(&spdx_license_ck)->implicit_value(true)->zero_tokens(),
            "check for SPDX license violations (default: off)")("copyright",
            value<bool>(&copyright_ck)->implicit_value(true)->zero_tokens(),
            "check for copyright violations (default: off)")("crlf",
            value<bool>(&crlf_ck)->implicit_value(true)->zero_tokens(),
            "check for crlf (line endings) violations (default: off)")("end",
            value<bool>(&end_ck)->implicit_value(true)->zero_tokens(),
            "check for missing newline at end of file violations (default: "
            "off)")("link",
            value<bool>(&link_ck)->implicit_value(true)->zero_tokens(),
            "check for unlinked files violations (default: off)")("path_name",
            value<bool>(&path_name_ck)->implicit_value(true)->zero_tokens(),
            "check for path name violations (default: off)")("tab",
            value<bool>(&tab_ck)->implicit_value(true)->zero_tokens(),
            "check for tab violations (default: off)")("ascii",
            value<bool>(&ascii_ck)->implicit_value(true)->zero_tokens(),
            "check for non-ascii character usage violations (default: off)")(
            "apple_macro",
            value<bool>(&apple_ck)->implicit_value(true)->zero_tokens(),
            "check for apple macro violations (default: off)")("windows_macro",
            value<bool>(&windows_ck)->implicit_value(true)->zero_tokens(),
            "check for windows macro violations (default: off)")("assert_macro",
            value<bool>(&assert_ck)->implicit_value(true)->zero_tokens(),
            "check for plain assert usage violations (default: off)")(
            "deprecated_macro",
            value<bool>(&deprecated_ck)->implicit_value(true)->zero_tokens(),
            "check for deprecated Boost configuration macro usage violations "
            "(default: off)")("minmax",
            value<bool>(&minmax_ck)->implicit_value(true)->zero_tokens(),
            "check for minmax usage violations (default: off)")("unnamed",
            value<bool>(&unnamed_ck)->implicit_value(true)->zero_tokens(),
            "check for unnamed namespace usage violations (default: off)")(
            "whitespace",
            value<bool>(&whitespace_ck)->implicit_value(true)->zero_tokens(),
            "check for endline whitespace violations (default: off)")("length",
            value<bool>(&length_ck)->implicit_value(true)->zero_tokens(),
            "check for exceeding character limit (default: off)")("include",
            value<bool>(&include_ck)->implicit_value(true)->zero_tokens(),
            "check for certain #include's (default: off)")("pragma_once",
            value<bool>(&pragma_once_ck)->implicit_value(true)->zero_tokens(),
            "check for #pragma once (default: off)")("deprecated_include",
            value<bool>(&deprecated_include_ck)
                ->implicit_value(true)
                ->zero_tokens(),
            "check for deprecated #include's (default: off)")("deprecated_name",
            value<bool>(&deprecated_names_ck)
                ->implicit_value(true)
                ->zero_tokens(),
            "check for deprecated names usage violations (default: off)")

            ("all,a",
                "check for all violations (default: no checks are performed)");
    ...
    cmdline.add_options()("pika:positional",
