...
if(HPXLocal_WITH_DATAPAR_VC AND NOT TARGET Vc::vc)
  ...
  if(NOT MSVC)
    ...
    hpx_local_add_config_cond_define(_SILENCE_ALL_CXX20_DEPRECATION_WARNINGS)
  endif()

  hpx_local_add_config_define(HPX_HAVE_DATAPAR)
  hpx_local_add_config_define(HPX_HAVE_DATAPAR_VC)
