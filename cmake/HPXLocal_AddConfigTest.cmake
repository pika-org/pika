...
function(hpx_local_add_config_test variable)
  ...
  if(${variable}_CHECK_CXXSTD AND ${variable}_CHECK_CXXSTD GREATER
    ...
    if(DEFINED ${variable})
      ...
      hpx_local_info(
        "Unsetting ${variable} because of HPXLocal_WITH_CXX_STANDARD (${HPXLocal_WITH_CXX_STANDARD})"
      )
    endif()
    return()
  endif()
    ...
    if(${variable}_EXECUTE)
      if(NOT CMAKE_CROSSCOMPILING)
        ...
        try_run(
          ...
          CXX_STANDARD ${HPXLocal_WITH_CXX_STANDARD}
...
# ##############################################################################
function(hpx_local_check_for_cxx20_trivial_virtual_destructor)
  hpx_local_add_config_test(
    HPXLocal_WITH_CXX20_TRIVIAL_VIRTUAL_DESTRUCTOR
