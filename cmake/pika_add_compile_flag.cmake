...
function(pika_add_target_compile_option FLAG)
  set(options PUBLIC)
  set(one_value_args)
...
function(pika_add_target_compile_option_if_available FLAG)
  set(options PUBLIC)
  ...
  foreach(_lang ${_languages})
    if(_lang STREQUAL "CXX")
      check_cxx_compiler_flag(${FLAG} PIKA_WITH_${_lang}_FLAG_${_name})
    else()
      pika_error("Unsupported language ${_lang}.")
    endif()
...
function(pika_remove_target_compile_option FLAG)
  set(options PUBLIC)
  set(one_value_args)
  ...
  set(_configurations "none")
  if(PIKA_ADD_TARGET_COMPILE_OPTION_CONFIGURATIONS)
    set(_configurations "${PIKA_ADD_TARGET_COMPILE_OPTION_CONFIGURATIONS}")
  endif()
...
function(pika_add_target_compile_definition FLAG)
  set(options PUBLIC)
  set(one_value_args)
  set(multi_value_args CONFIGURATIONS)
  cmake_parse_arguments(
...
function(pika_add_compile_flag)
  set(one_value_args)
  pika_add_target_compile_option(${ARGN})
endfunction()

function(pika_add_compile_flag_if_available FLAG)
  set(options PUBLIC)
  set(one_value_args NAME)
  set(multi_value_args CONFIGURATIONS LANGUAGES)
  cmake_parse_arguments(
  ...
  set(_public)
  if(PIKA_ADD_COMPILE_FLAG_IA_PUBLIC)
    set(_public PUBLIC)
  endif()

  if(PIKA_ADD_COMPILE_FLAG_IA_NAME)
    string(TOUPPER ${PIKA_ADD_COMPILE_FLAG_IA_NAME} _name)
  else()
    string(TOUPPER ${FLAG} _name)
  endif()
  ...
  set(_languages "CXX")
  if(PIKA_ADD_COMPILE_FLAG_IA_LANGUAGES)
    set(_languages ${PIKA_ADD_COMPILE_FLAG_IA_LANGUAGES})
  endif()
