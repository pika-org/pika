...
set(PIKA_PLATFORM_CHOICES "Choices are: native, Android, XeonPhi, BlueGeneQ.")
...
string(FIND "${PIKA_PLATFORMS_UC}" "${PIKA_PLATFORM_UC}" _PLATFORM_FOUND)
if(_PLATFORM_FOUND EQUAL -1)
  pika_error("Unknown platform in PIKA_PLATFORM. ${PIKA_PLATFORM_CHOICES}")
endif()
