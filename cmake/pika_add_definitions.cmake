...
function(pika_add_config_define definition)
...
function(pika_add_config_cond_define definition)
...
function(pika_write_config_defines_file)
  ...
  foreach(def ${COND_DEFINITIONS_VAR})
    ...
    if(NOT ${_pos} EQUAL -1)
      set(pika_config_defines
          "${pika_config_defines}#if __cplusplus >= 202002 && !defined(${defname})\n#define ${def}\n#endif\n"
      )
    else()
      ...
      if(NOT ${_pos} EQUAL -1)
        set(pika_config_defines
            "${pika_config_defines}#if __cplusplus >= 201500 && !defined(${defname})\n#define ${def}\n#endif\n"
        )
      else()
        set(pika_config_defines
            "${pika_config_defines}#if !defined(${defname})\n#define ${def}\n#endif\n"
        )
      endif()
    endif()
  endforeach()
