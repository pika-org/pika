...
if(NOT HPXLocal_FIND_PACKAGE)
  ...
  if(NOT HPXLocal_WITH_CXX17_ALIGNED_NEW)
    hpx_local_add_config_cond_define(ASIO_DISABLE_STD_ALIGNED_ALLOC)
  endif()
  # Asio does not detect that invoke_result is available, but we assume it
  # always is since we require C++17.
  hpx_local_add_config_cond_define(ASIO_HAS_STD_INVOKE_RESULT 1)
