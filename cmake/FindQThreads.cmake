...
find_path(
  ...
  HINTS ${QTHREADS_ROOT} ENV QTHREADS_ROOT ${PC_QTHREADS_INCLUDEDIR} ${PC_QTHREADS_INCLUDE_DIRS}
...
find_library(
  ...
  HINTS ${QTHREADS_ROOT} ENV QTHREADS_ROOT ${PC_QTHREADS_LIBDIR} ${PC_QTHREADS_LIBRARY_DIRS}
...
find_package_handle_standard_args(QThreads DEFAULT_MSG QTHREADS_LIBRARY QTHREADS_INCLUDE_DIR)
