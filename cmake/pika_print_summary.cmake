...
function(pika_create_configuration_summary message module_name)

  set(pika_config_information)
  set(upper_cfg_name "PIKA")
  set(upper_option_suffix "")

  string(TOUPPER ${module_name} module_name_uc)
  if(NOT "${module_name_uc}x" STREQUAL "PIKAx")
    set(upper_cfg_name "PIKA_${module_name_uc}")
  ...
  if(${_length} GREATER_EQUAL 1)
    ...
    foreach(_variableName ${_variableNames})
      if(${_variableName}Category)
        ...
        # handle only options which start with PIKA_WITH_
        ...
        if(${__pos} EQUAL 0)
          ...
          pika_info("    ${_variableName}=${_value}")
        endif()
