...
namespace hpx { namespace parallel { namespace execution {
    ...
    using parallel_execution_tag HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using sequenced_execution_tag HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using task_policy_tag HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using unsequenced_execution_tag HPX_LOCAL_DEPRECATED_V(0, 1,
