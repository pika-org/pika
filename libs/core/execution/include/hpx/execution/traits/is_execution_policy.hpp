...
namespace hpx { namespace parallel { namespace execution {
    ...
    template <typename T>
    using is_sequenced_execution_policy HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    /// \cond
    template <typename T>
    using is_async_execution_policy HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    template <typename T>
    using is_rebound_execution_policy HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    template <typename T>
    using is_vectorpack_execution_policy HPX_LOCAL_DEPRECATED_V(0, 1,
