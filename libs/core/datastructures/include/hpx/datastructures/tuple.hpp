...
// https://github.com/ROCm-Developer-Tools/HIP/issues/2173
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE tuple<Ts&&...> forward_as_tuple(
        Ts&&... vs) noexcept
    {
        return tuple<Ts&&...>(HPX_FORWARD(Ts, vs)...);
    }
...
namespace hpx { namespace util {
    HPX_LOCAL_DEPRECATED_V(
        0, 1, "hpx::util::ignore is deprecated. Use hpx::ignore instead.")
    hpx::detail::ignore_type const ignore = {};

    template <typename... Ts>
    using tuple HPX_LOCAL_DEPRECATED_V(
        0, 1, "hpx::util::tuple is deprecated. Use hpx::tuple instead.") =
        hpx::tuple<Ts...>;
    template <typename T>
    using tuple_size HPX_LOCAL_DEPRECATED_V(0, 1,
        "hpx::util::tuple_size is deprecated. Use hpx::tuple_size instead.") =
        hpx::tuple_size<T>;
    template <std::size_t I, typename T>
    using tuple_element HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    template <typename... Ts>
    HPX_LOCAL_DEPRECATED_V(
        0, 1, "hpx::util::tie is deprecated. Use hpx::tie instead.")
