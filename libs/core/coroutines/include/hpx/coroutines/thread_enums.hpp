...
#define HPX_THREAD_STATE_UNSCOPED_ENUM_DEPRECATION_MSG                         \
    ...
    HPX_LOCAL_DEPRECATED_V(0, 1, HPX_THREAD_STATE_UNSCOPED_ENUM_DEPRECATION_MSG)
...
#define HPX_THREAD_PRIORITY_UNSCOPED_ENUM_DEPRECATION_MSG                      \
    ...
    HPX_LOCAL_DEPRECATED_V(
        0, 1, HPX_THREAD_PRIORITY_UNSCOPED_ENUM_DEPRECATION_MSG)
...
#define HPX_THREAD_STATE_EX_UNSCOPED_ENUM_DEPRECATION_MSG                      \
    ...
    HPX_LOCAL_DEPRECATED_V(
        0, 1, HPX_THREAD_STATE_EX_UNSCOPED_ENUM_DEPRECATION_MSG)
...
#define HPX_THREAD_STACKSIZE_UNSCOPED_ENUM_DEPRECATION_MSG                     \
    ...
    HPX_LOCAL_DEPRECATED_V(
        0, 1, HPX_THREAD_STACKSIZE_UNSCOPED_ENUM_DEPRECATION_MSG)
...
#define HPX_THREAD_SCHEDULE_HINT_UNSCOPED_ENUM_DEPRECATION_MSG                 \
    ...
    HPX_LOCAL_DEPRECATED_V(
        0, 1, HPX_THREAD_SCHEDULE_HINT_UNSCOPED_ENUM_DEPRECATION_MSG)
