...
# endif
    ...
    public:
        ...
        /// available
        bool get_next_thread(threads::detail::thread_id_ref_type& thrd, [[maybe_unused]] bool allow_stealing = false,
            [[maybe_unused]] bool steal = false) PIKA_HOT
        {
