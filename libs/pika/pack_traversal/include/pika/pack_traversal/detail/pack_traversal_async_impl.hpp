...
namespace pika {
    namespace util { namespace detail {
        ...
        public:
            ...
            void async_continue(T&& value, Hierarchy&& hierarchy)
            {
                ...
                PIKA_INVOKE(visitor(), async_traverse_detach_tag{},
                    PIKA_FORWARD(T, value), PIKA_MOVE(resumable));
            }
    ...
    namespace util { namespace detail {
        ...
        public:
            ...
            {
                using ElementType =
                    typename pika::util::decay_unwrap<decltype(*current)>::type;
                return async_traverse_one_impl(
                    container_category_of_t<ElementType>{},
                    PIKA_FORWARD(Current, current));
            }
