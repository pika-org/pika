...
#include <pika/type_support/detected.hpp>
...
namespace pika { namespace parallel { namespace execution {
    ...
    namespace detail {
        ...
        PIKA_HAS_MEMBER_XXX_TRAIT_DEF(sync_execute)
        PIKA_HAS_MEMBER_XXX_TRAIT_DEF(async_execute)
        PIKA_HAS_MEMBER_XXX_TRAIT_DEF(then_execute)
        PIKA_HAS_MEMBER_XXX_TRAIT_DEF(bulk_sync_execute)
        PIKA_HAS_MEMBER_XXX_TRAIT_DEF(bulk_async_execute)
        PIKA_HAS_MEMBER_XXX_TRAIT_DEF(bulk_then_execute)
    }    // namespace detail
