...
namespace pika::let_value_detail {
    ...
    {
        [[noreturn]] void PIKA_STATIC_CALL_OPERATOR(pika::detail::monostate) { PIKA_UNREACHABLE; }
    ...
    struct set_value_visitor
    {
        ...
        template <typename T,
            typename = std::enable_if_t<!std::is_same_v<std::decay_t<T>, pika::detail::monostate>>>
        void operator()(T& t)
        {
...
# else
            ...
            op_state.successor_op_state.template emplace_f<operation_state_type>(
                pika::execution::experimental::connect, std::apply(std::move(op_state.f), t),
...
# endif
    ...
    struct operation_state
    {
        ...
        using successor_operation_state_types = pika::util::detail::transform_t<
            typename types::template successor_sender_types<Tuple, Variant>,
        ...
        using predecessor_ts_type = pika::util::detail::prepend_t<
            typename types::template predecessor_value_types<std::tuple, pika::detail::variant>,
        ...
        struct let_value_predecessor_receiver
        {
                    ...
                    void())
            {
                ...
                pika::detail::try_catch_exception_ptr(
                    [&]() {
                        r.op_state.predecessor_ts.template emplace<std::tuple<std::decay_t<Ts>...>>(
                            std::forward<Ts>(ts)...);
                        pika::detail::visit(set_value_visitor<operation_state>{r.op_state},
    ...
    struct let_value_sender
    {
        ...
        using error_types = pika::util::detail::unique_t<pika::util::detail::prepend_t<
            pika::util::detail::concat_pack_of_packs_t<pika::util::detail::transform_t<
                typename types::template successor_sender_types<pika::util::detail::pack, Variant>,
...
namespace pika::execution::experimental {
    ...
    private:
        ...
        {
            return let_value_detail::let_value_sender<std::decay_t<PredecessorSender>,
                std::decay_t<F>>{
