...
namespace pika::split_tuple_detail {
    ...
    struct shared_state
    {
        ...
        using predecessor_tuple_value_type =
        ...
        using value_type = std::decay_t<predecessor_tuple_value_type>;
        using error_type =
        ...
        std::array<continuation_type,
            std::tuple_size_v<std::decay_t<predecessor_tuple_value_type>>>
            continuations;
        ...
        using predecessor_tuple_value_type =
            pika::execution::experimental::detail::single_result_t<
                typename pika::execution::experimental::sender_traits<
                    ...
                    pika::util::detail::pack>>;
        static_assert(
            std::tuple_size_v<std::decay_t<predecessor_tuple_value_type>> >= 1,
            "split_tuple takes a sender that sends a tuple of at least one "
            "type");
        template <template <typename...> class Tuple,
            template <typename...> class Variant>
        using value_types =
            Variant<Tuple<std::decay_t<std::tuple_element_t<Index,
                std::decay_t<predecessor_tuple_value_type>>>>>;
    ...
    auto make_split_tuple_senders(Sender&& sender, Allocator const& allocator)
    {
        ...
        return make_split_tuple_senders<std::decay_t<Sender>,
            ...
            pika::util::detail::make_index_pack_t<std::tuple_size_v<
                std::decay_t<predecessor_tuple_value_type>>>{});
    }
}    // namespace pika::split_tuple_detail
