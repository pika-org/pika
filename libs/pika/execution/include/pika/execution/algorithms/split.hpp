...
namespace pika::split_detail {
    ...
    struct shared_state
    {
        ...
        using operation_state_type =
            std::decay_t<pika::execution::experimental::connect_result_t<Sender, split_receiver>>;
    ...
    struct split_sender
    {
        ...
        split_sender(Sender_&& sender, Allocator const& allocator)
        {
            ...
            new (p.get()) shared_state_type{std::forward<Sender_>(sender), allocator};
            state = p.release();
        }
...
namespace pika::execution::experimental {
    ...
    private:
        ...
        {
            return split_detail::split_sender<std::decay_t<Sender>, std::decay_t<Allocator>>{
