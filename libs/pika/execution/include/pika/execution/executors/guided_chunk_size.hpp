...
namespace pika { namespace parallel { namespace execution {
    using guided_chunk_size PIKA_DEPRECATED_V(0, 1,
        "pika::parallel::execution::guided_chunk_size is deprecated. Use "
        "pika::execution::guided_chunk_size instead.") =
        pika::execution::guided_chunk_size;
