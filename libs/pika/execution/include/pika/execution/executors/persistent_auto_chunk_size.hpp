...
namespace pika { namespace parallel { namespace execution {
    using persistent_auto_chunk_size PIKA_DEPRECATED_V(0, 1,
        "pika::parallel::execution::persistent_auto_chunk_size is deprecated. "
        "Use pika::execution::persistent_auto_chunk_size instead.") =
        pika::execution::persistent_auto_chunk_size;
