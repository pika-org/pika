...
namespace pika::parallel::execution::detail {
            ...
            !pika::traits::is_two_way_executor_v<Executor>>>
    {
        ...
        PIKA_FORCEINLINE static auto call(OneWayExecutor&& exec, F&& f,
            ...
            PIKA_FORWARD(Ts, ts)...))
        {
            return sync_execute_dispatch(0, PIKA_FORWARD(OneWayExecutor, exec),
                PIKA_FORWARD(F, f), PIKA_FORWARD(Ts, ts)...);
        }
            ...
            !pika::traits::is_two_way_executor_v<Executor>>>
    {
        ...
        {
            using type =
                decltype(call(std::declval<OneWayExecutor>(), std::declval<F>(),
            ...
            !pika::traits::is_never_blocking_one_way_executor_v<Executor>>>
    {
        ...
        PIKA_FORCEINLINE static void call_impl(
            pika::detail::wrap_int, OneWayExecutor&& exec, F&& f, Ts&&... ts)
        {
        ...
        template <typename OneWayExecutor, typename F, typename... Ts>
        PIKA_FORCEINLINE static auto
        call_impl(int, OneWayExecutor&& exec, F&& f, Ts&&... ts)
        ...
        template <typename OneWayExecutor, typename F, typename... Ts>
        PIKA_FORCEINLINE static auto
        call(OneWayExecutor&& exec, F&& f, Ts&&... ts) -> decltype(call_impl(
            0, exec, PIKA_FORWARD(F, f), PIKA_FORWARD(Ts, ts)...))
        {
        ...
        std::enable_if_t<pika::traits::is_two_way_executor_v<Executor>>>
    {
        ...
        template <typename TwoWayExecutor, typename F, typename Future,
            typename... Ts>
        PIKA_FORCEINLINE static auto call_impl(
            int, TwoWayExecutor&& exec, F&& f, Future&& predecessor, Ts&&... ts)
        ...
        {
            using type =
                decltype(call(std::declval<TwoWayExecutor>(), std::declval<F>(),
                    std::declval<Future>(), std::declval<Ts>()...));
        };
    };
    ...
    template <typename Executor, typename F, typename Shape, typename... Ts>
    auto
    bulk_async_execute_dispatch(pika::detail::wrap_int, Executor&& /* exec */,
    ...
    struct bulk_function_result
    {
        ...
        using type =
            pika::util::detail::invoke_deferred_result_t<F, value_type, Ts...>;
    };
                ...
                is_bulk_two_way_executor_v<Executor>>>
    {
        ...
        {
            using type =
                decltype(call(std::declval<BulkExecutor>(), std::declval<F>(),
    ...
    template <typename Executor, typename F, typename Shape, typename... Ts>
    auto
    bulk_sync_execute_dispatch(pika::detail::wrap_int, Executor&& /* exec */,
        F&& /* f */, Shape const& /* shape */, Ts&&... /* ts */)
        ...
        std::enable_if_t<!pika::traits::is_bulk_two_way_executor_v<Executor>>>
    {
            ...
            -> pika::future<bulk_then_execute_result_t<F, Shape, Future, Ts...>>
        {
            ...
            auto func = make_fused_bulk_sync_execute_helper<result_type>(exec,
        ...
        template <typename BulkExecutor, typename F, typename Shape,
            typename Future, typename... Ts>
        static pika::future<void> call_impl(std::true_type, BulkExecutor&& exec,
        ...
        template <typename BulkExecutor, typename F, typename Shape,
            typename Future, typename... Ts>
        PIKA_FORCEINLINE static auto call_impl(int, BulkExecutor&& exec, F&& f,
            Shape const& shape, Future&& predecessor, Ts&&... ts)
        ...
        std::enable_if_t<pika::traits::is_bulk_two_way_executor_v<Executor>>>
    {
            ...
            bulk_then_execute_result_t<F, Shape, Future, Ts...>>
        {
            ...
            auto func = make_fused_bulk_async_execute_helper<result_type>(exec,
                PIKA_FORWARD(F, f), shape,
                std::make_tuple(PIKA_FORWARD(Ts, ts)...));
            ...
            shared_state_type p =
                lcos::detail::make_continuation_exec<vector_result_type>(
                    ...
                    [func = PIKA_MOVE(func)](future_type&& predecessor) mutable
                    -> vector_result_type {
