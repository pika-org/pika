...
///////////////////////////////////////////////////////////////////////////////
void produce_numbers(pika::experimental::channel_spsc<int>& c2,
    pika::experimental::channel_spsc<int>& c3)
{
    int f1 = 1, f2 = 0;
...
void consume_numbers(int n, pika::experimental::channel_spsc<bool>& c1,
    pika::experimental::channel_spsc<int>& c2,
    pika::experimental::channel_spsc<int>& c3)
{
    channel_set(c2, n);
...
int pika_main()
{
    pika::experimental::channel_spsc<bool> c1(1);
