...
///////////////////////////////////////////////////////////////////////////////
int thread_func(int i, pika::lcos::local::channel_spsc<int>& channel,
    pika::lcos::local::channel_spsc<int>& next)
{
...
int pika_main()
{
    std::vector<pika::lcos::local::channel_spsc<int>> channels;
