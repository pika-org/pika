...
///////////////////////////////////////////////////////////////////////////////
template <typename T>
inline T channel_get(pika::lcos::channel_mpsc<T> const& c)
{
    T result;
    while (!c.get(&result))
    {
...
template <typename T>
inline void channel_set(pika::lcos::channel_mpsc<T>& c, T val)
{
...
///////////////////////////////////////////////////////////////////////////////
void produce_numbers(pika::lcos::channel_mpsc<int>& c2,
    pika::lcos::channel_mpsc<int>& c3)
{
    int f1 = 1, f2 = 0;
...
void consume_numbers(int n, pika::lcos::channel_mpsc<bool>& c1,
    pika::lcos::channel_mpsc<int>& c2,
    pika::lcos::channel_mpsc<int>& c3)
{
    channel_set(c2, n);
...
int pika_main()
{
    pika::lcos::channel_mpsc<bool> c1(1);
    pika::lcos::channel_mpsc<int> c2(1);
    pika::lcos::channel_mpsc<int> c3(5);
