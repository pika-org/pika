...
///////////////////////////////////////////////////////////////////////////////
int thread_func(int i, pika::lcos::local::channel_mpsc<int>& channel,
    pika::lcos::local::channel_mpsc<int>& next)
{
...
int pika_main()
{
    std::vector<pika::lcos::local::channel_mpsc<int>> channels;
