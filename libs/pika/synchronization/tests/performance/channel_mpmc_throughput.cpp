...
///////////////////////////////////////////////////////////////////////////////
inline data channel_get(pika::lcos::channel_mpmc<data> const& c)
{
    data result;
    while (!c.get(&result))
    {
...
inline void channel_set(pika::lcos::channel_mpmc<data>& c, data&& val)
{
...
///////////////////////////////////////////////////////////////////////////////
// Produce
double thread_func_0(pika::lcos::channel_mpmc<data>& c)
{
...
// Consume
double thread_func_1(pika::lcos::channel_mpmc<data>& c)
{
    auto start = std::chrono::high_resolution_clock::now();
...
int pika_main()
{
    pika::lcos::channel_mpmc<data> c(10000);
