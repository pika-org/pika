...
///////////////////////////////////////////////////////////////////////////////
inline data channel_get(pika::lcos::local::channel_mpmc<data> const& c)
{
    data result;
    while (!c.get(&result))
    {
...
inline void channel_set(pika::lcos::local::channel_mpmc<data>& c, data&& val)
{
...
int pika_main()
{
    pika::lcos::local::channel_mpmc<data> c(10000);
