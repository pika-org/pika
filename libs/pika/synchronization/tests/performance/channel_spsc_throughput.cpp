...
///////////////////////////////////////////////////////////////////////////////
inline data channel_get(pika::lcos::local::channel_spsc<data> const& c)
{
    data result;
    while (!c.get(&result))
    {
...
inline void channel_set(pika::lcos::local::channel_spsc<data>& c, data&& val)
{
...
///////////////////////////////////////////////////////////////////////////////
// Produce
double thread_func_0(pika::lcos::local::channel_spsc<data>& c)
{
...
// Consume
double thread_func_1(pika::lcos::local::channel_spsc<data>& c)
{
    std::uint64_t start = pika::chrono::high_resolution_clock::now();
...
int pika_main()
{
    pika::lcos::local::channel_spsc<data> c(10000);
