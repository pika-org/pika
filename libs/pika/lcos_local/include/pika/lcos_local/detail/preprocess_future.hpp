...
namespace pika { namespace serialization { namespace detail {
    ...
    public:
        ...
        {
            PIKA_ASSERT(done_);
            PIKA_ASSERT(num_futures_ == 0);
            PIKA_ASSERT(num_futures_ == triggered_futures_);
        }
        ...
        void trigger()
        {
            // pika::lcos::local::promise<>::set_value() might need to acquire
        ...
        void await_future(
            pika::lcos::detail::future_data_refcnt_base& future_data,
        ...
        void reset()
        {
            ...
            num_futures_ = 0;
            triggered_futures_ = 0;
            promise_ = pika::lcos::local::promise<void>();
        }
        ...
        void operator()(F f)
        {
            ...
            pika::future<void> fut = promise_.get_future();
    ...
    private:
        ...
        pika::lcos::local::promise<void> promise_;
    };
