...
namespace pika { namespace lcos { namespace local {
    namespace detail {
        ...
        public:
            ...
            set_value(Ts&&... ts)
            {
                ...
                shared_state_->set_value(PIKA_FORWARD(Ts, ts)...);
            }
            ...
            void set_exception(T&& value)
            {
                ...
                shared_state_->set_exception(PIKA_FORWARD(T, value));
            }
    ...
    public:
        ...
        //          promise(PIKA_MOVE(other)).swap(*this).
        // Returns: *this.
        ...
        {
            base_type::set_value(PIKA_FORWARD(Ts, ts)...);
        }
