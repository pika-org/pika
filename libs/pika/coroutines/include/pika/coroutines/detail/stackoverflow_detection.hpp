...
namespace pika::threads::coroutines::detail {
    ...
    inline void sigsegv_handler([[maybe_unused]] int signum, siginfo_t* infoptr, void* ctxptr)
    {
...
# endif
    ...
    inline void set_sigsegv_handler(struct sigaction& action, stack_t& segv_stack)
    {
