...
void test_split_future1()
{
    ...
    std::tuple<pika::future<int>> result =
        pika::split_future(pika::shared_future<std::tuple<int>>(pt.get_future()));
...
void test_split_future2()
{
    ...
    std::tuple<pika::future<int>, pika::future<int>> result =
        pika::split_future(pika::shared_future<std::tuple<int, int>>(pt.get_future()));
...
void test_split_future3()
{
    ...
    std::tuple<pika::future<int>, pika::future<int>, pika::future<int>> result =
        pika::split_future(pika::shared_future<std::tuple<int, int, int>>(pt.get_future()));
...
void test_split_future_pair()
{
    ...
    std::pair<pika::future<int>, pika::future<int>> result =
        pika::split_future(pika::shared_future<std::pair<int, int>>(pt.get_future()));
