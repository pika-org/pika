...
namespace pika { namespace threads {
    ...
    {
        PIKA_NON_COPYABLE(pika_hwloc_bitmap_wrapper);
        ...
        pika_hwloc_bitmap_wrapper(void* bmp)
    ...
    using hwloc_bitmap_ptr = std::shared_ptr<pika_hwloc_bitmap_wrapper>;

    /// \brief Please see hwloc documentation for the corresponding
    /// enums HWLOC_MEMBIND_XXX
    enum pika_hwloc_membind_policy : int
    {
