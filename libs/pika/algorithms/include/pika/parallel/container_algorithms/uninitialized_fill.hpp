...
namespace pika { namespace ranges {
    ...
    private:
        ...
        // clang-format on
        friend FwdIter tag_fallback_invoke(pika::ranges::uninitialized_fill_t,
            FwdIter first, Sent last, T const& value)
        {
            static_assert(pika::traits::is_forward_iterator<FwdIter>::value,
                "Requires at least forward iterator.");

            return pika::parallel::detail::uninitialized_fill<FwdIter>()
        ...
        tag_fallback_invoke(
            pika::ranges::uninitialized_fill_t, Rng&& rng, T const& value)
        {
            using iterator_type =
            ...
            return pika::parallel::detail::uninitialized_fill<
                iterator_type>()
    ...
    private:
        ...
        // clang-format on
        friend FwdIter tag_fallback_invoke(pika::ranges::uninitialized_fill_n_t,
            FwdIter first, Size count, T const& value)
        {
            static_assert(pika::traits::is_forward_iterator<FwdIter>::value,
                "Requires at least forward iterator.");

            return pika::parallel::detail::uninitialized_fill_n<FwdIter>()
