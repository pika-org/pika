...
namespace pika { namespace ranges {
    ...
    ///           \a pika::future<ranges::set_union_result<Iter1, Iter2, Iter3>>
...
namespace pika::ranges {
    ...
    private:
            ...
            Proj2&& proj2 = Proj2())
        {
            ...
            return pika::parallel::detail::set_union<result_type>().call2(
        ...
        // clang-format on
        friend typename pika::parallel::detail::algorithm_result<ExPolicy,
            set_union_result<typename pika::traits::range_iterator<Rng1>::type,
            ...
            Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2())
        {
            ...
            return pika::parallel::detail::set_union<result_type>().call(
