...
#endif
        static_assert(pika::traits::is_random_access_iterator_v<iterator_type>,
...
namespace pika { namespace ranges {
    ...
    private:
            ...
            Proj&& proj = Proj())
        {
            ...
            return pika::parallel::v1::detail::stable_sort<RandomIt>().call(
            ...
            Compare&& comp = Compare(), Proj&& proj = Proj())
        {
            ...
            return pika::parallel::v1::detail::stable_sort<iterator_type>().call(
