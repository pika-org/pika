...
namespace pika { namespace parallel { inline namespace v1 {
    ...
    PIKA_DEPRECATED_V(0, 1,
        "pika::parallel::is_heap is deprecated, use pika::ranges::is_heap "
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        return pika::parallel::v1::detail::is_heap_until<iterator_type>().call(
            PIKA_FORWARD(ExPolicy, policy), pika::util::begin(rng),
            pika::util::end(rng), PIKA_FORWARD(Comp, comp),
            PIKA_FORWARD(Proj, proj));
#if defined(PIKA_GCC_VERSION) && PIKA_GCC_VERSION >= 100000
...
namespace pika { namespace ranges {
    ...
    ///////////////////////////////////////////////////////////////////////////
    // DPO for pika::ranges::is_heap_until
    ...
    private:
            ...
            Comp&& comp = Comp(), Proj&& proj = Proj())
        {
            ...
            return pika::parallel::v1::detail::is_heap_until<iterator_type>()
