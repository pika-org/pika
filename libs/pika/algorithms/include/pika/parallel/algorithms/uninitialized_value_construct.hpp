...
namespace pika { namespace parallel { inline namespace v1 {
    ...
    PIKA_DEPRECATED_V(0, 1,
        "pika::parallel::uninitialized_value_construct is deprecated, use "
...
#pragma GCC diagnostic pop
    ...
    template <typename ExPolicy, typename FwdIter, typename Size,
        PIKA_CONCEPT_REQUIRES_(pika::is_execution_policy<ExPolicy>::value&&
                pika::traits::is_iterator<FwdIter>::value)>
    PIKA_DEPRECATED_V(0, 1,
        "pika::parallel::uninitialized_value_construct_n is deprecated, use "
        "pika::uninitialized_value_construct_n "
        "instead")
    typename util::detail::algorithm_result<ExPolicy, FwdIter>::type
        uninitialized_value_construct_n(
            ExPolicy&& policy, FwdIter first, Size count)
...
namespace pika {
      ...
      : pika::detail::tag_parallel_algorithm<uninitialized_value_construct_t>
    {
        ...
        friend void tag_fallback_invoke(
            pika::uninitialized_value_construct_t, FwdIter first, FwdIter last)
        {
            static_assert(pika::traits::is_forward_iterator<FwdIter>::value,
                "Requires at least forward iterator.");

            pika::parallel::v1::detail::uninitialized_value_construct<FwdIter>()
      ...
      : pika::detail::tag_parallel_algorithm<uninitialized_value_construct_n_t>
    {
        ...
        friend FwdIter tag_fallback_invoke(
            pika::uninitialized_value_construct_n_t, FwdIter first, Size count)
        {
            static_assert(pika::traits::is_forward_iterator<FwdIter>::value,
                "Requires at least forward iterator.");
