...
namespace pika { namespace parallel { namespace util {
    ...
    namespace detail {
        ...
        tag_invoke(pika::parallel::util::detail::extract_value_t<ExPolicy>,
            Vector const& value)
        {
        ...
        struct loop_optimization
        {
            ...
            PIKA_FORCEINLINE static constexpr bool call(
    ...
    PIKA_HOST_DEVICE PIKA_FORCEINLINE auto tag_invoke(
        pika::parallel::util::loop_step_t<ExPolicy>, std::false_type, F&& f,
        Iter1& it1, Iter2& it2)
    ...
    template <typename ExPolicy, typename F, typename Iter1, typename Iter2,
        typename U = typename std::enable_if<
            pika::is_vectorpack_execution_policy<ExPolicy>::value>::type>
    PIKA_HOST_DEVICE PIKA_FORCEINLINE auto tag_invoke(
        pika::parallel::util::loop_step_t<ExPolicy>, std::true_type, F&& f,
        Iter1& it1, Iter2& it2)
    ...
    tag_invoke(pika::parallel::util::loop_optimization_t<ExPolicy>, Iter first1,
        Sent last1)
    {
    ...
    template <typename Begin, typename End, typename F>
    PIKA_HOST_DEVICE PIKA_FORCEINLINE Begin tag_invoke(
        pika::parallel::util::loop_ind_t, pika::execution::simd_policy,
        Begin begin, End end, F&& f)
    {
    ...
    template <typename Begin, typename End, typename F>
    PIKA_HOST_DEVICE PIKA_FORCEINLINE Begin tag_invoke(
        pika::parallel::util::loop_ind_t, pika::execution::simd_task_policy,
        Begin begin, End end, F&& f)
    {
        return detail::datapar_loop_ind<Begin>::call(
            begin, end, PIKA_FORWARD(F, f));
    ...
    tag_invoke(pika::parallel::util::loop2_t<ExPolicy>, VecOnly&&, Iter1 first1,
    ...
    tag_invoke(pika::parallel::util::loop_n_t<ExPolicy>, Iter it,
        std::size_t count, F&& f)
    {
        return pika::parallel::util::detail::datapar_loop_n<Iter>::call(
    ...
    PIKA_HOST_DEVICE PIKA_FORCEINLINE constexpr typename std::enable_if<
        pika::is_vectorpack_execution_policy<ExPolicy>::value, Iter>::type
    tag_invoke(pika::parallel::util::loop_n_ind_t<ExPolicy>, Iter it,
        std::size_t count, F&& f)
    {
        return pika::parallel::util::detail::datapar_loop_n_ind<Iter>::call(
            it, count, PIKA_FORWARD(F, f));
    }
    ...
    PIKA_HOST_DEVICE PIKA_FORCEINLINE constexpr typename std::enable_if<
        pika::is_vectorpack_execution_policy<ExPolicy>::value, Iter>::type
    tag_invoke(pika::parallel::util::loop_idx_n_t<ExPolicy>,
        std::size_t base_idx, Iter it, std::size_t count, F&& f)
    {
        return pika::parallel::util::detail::datapar_loop_idx_n<Iter>::call(
