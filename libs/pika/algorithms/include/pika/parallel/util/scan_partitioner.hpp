        ...
        struct scan_static_partitioner
        {
                ...
                F3&& f3, F4&& f4)
            {
                ...
                try
                {
                    ...
                    workitems.push_back(
                        make_ready_future(PIKA_FORWARD(T, init)));
                ...
                F3&& f3, F4&& f4)
            {
                ...
                try
                {
                    ...
                    if (tested)
                    {
                        ...
                        finalitems.push_back(
                            dataflow(pika::launch::sync, f3, first_,
            ...
            {
                return call(ScanPartTag{}, PIKA_FORWARD(ExPolicy_, policy),
                    first, count, PIKA_FORWARD(T, init), PIKA_FORWARD(F1, f1),
