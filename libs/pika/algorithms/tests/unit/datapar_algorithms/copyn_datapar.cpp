...
void test_copy_n()
{
    ...
    test_copy_n(pika::execution::simd, IteratorTag());
    test_copy_n(pika::execution::par_simd, IteratorTag());
...
void test_copy_n_exception()
{
    ...
    test_copy_n_exception(pika::execution::simd, IteratorTag());
    test_copy_n_exception(pika::execution::par_simd, IteratorTag());
...
{
    test_copy_n_bad_alloc(pika::execution::simd, IteratorTag());
    test_copy_n_bad_alloc(pika::execution::par_simd, IteratorTag());
