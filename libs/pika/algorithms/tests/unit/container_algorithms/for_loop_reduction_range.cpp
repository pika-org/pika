...
{
    test_for_loop_reduction_plus(pika::execution::seq);
    test_for_loop_reduction_plus(pika::execution::par);
    test_for_loop_reduction_plus(pika::execution::par_unseq);

    test_for_loop_reduction_multiplies(pika::execution::seq);
    test_for_loop_reduction_multiplies(pika::execution::par);
    test_for_loop_reduction_multiplies(pika::execution::par_unseq);

    test_for_loop_reduction_min(pika::execution::seq);
    test_for_loop_reduction_min(pika::execution::par);
    test_for_loop_reduction_min(pika::execution::par_unseq);
}
