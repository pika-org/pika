...
void test_copy_n(IteratorTag)
{
    ...
    pika::ranges::copy_n(iterator(std::begin(c)), c.size(), std::begin(d));
...
void test_copy_n_exception(IteratorTag)
{
    ...
    try
    {
        pika::ranges::copy_n(decorated_iterator(std::begin(c),
