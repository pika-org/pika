...
{
    test_for_loop_induction(pika::execution::seq);
    test_for_loop_induction(pika::execution::par);
    test_for_loop_induction(pika::execution::par_unseq);

    test_for_loop_induction_stride(pika::execution::seq);
    test_for_loop_induction_stride(pika::execution::par);
    test_for_loop_induction_stride(pika::execution::par_unseq);

    test_for_loop_induction_life_out(pika::execution::seq);
    test_for_loop_induction_life_out(pika::execution::par);
    test_for_loop_induction_life_out(pika::execution::par_unseq);

    test_for_loop_induction_stride_life_out(pika::execution::seq);
    test_for_loop_induction_stride_life_out(pika::execution::par);
    test_for_loop_induction_stride_life_out(pika::execution::par_unseq);
}
