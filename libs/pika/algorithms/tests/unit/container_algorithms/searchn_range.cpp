...
void test_search_n1_without_expolicy(IteratorTag)
{
    ...
    auto index = pika::ranges::search_n(c, c.size(), h);
...
void test_search_n1(ExPolicy policy, IteratorTag)
{
    ...
    auto index = pika::ranges::search_n(policy, c, c.size(), h);
    auto test_index = std::begin(c) + c.size() / 2;
...
void test_search_n1_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::ranges::search_n(p, c, c.size(), h);
    f.wait();
...
void test_search_n4(ExPolicy policy, IteratorTag)
{
    ...
    auto index = pika::ranges::search_n(policy, c, c.size(), h, op);
...
void test_search_n4_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::ranges::search_n(p, c, c.size(), h, op);
    f.wait();
...
void test_search_n5(ExPolicy policy, IteratorTag)
{
    ...
    auto index =
        pika::ranges::search_n(policy, c, c.size(), h, op, proj1, proj2);
...
void test_search_n5_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::ranges::search_n(p, c, c.size(), h, op, proj1, proj2);
