...
void test_search1(IteratorTag)
{
    ...
    auto index = pika::ranges::search(c, h);
...
void test_search1(ExPolicy policy, IteratorTag)
{
    ...
    auto index = pika::ranges::search(policy, c, h);
    auto test_index = std::begin(c) + c.size() / 2;
...
void test_search1_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::ranges::search(p, c, h);
    f.wait();
...
void test_search4_sentinel(IteratorTag)
{
    ...
    iterator index =
        pika::ranges::search(iterator(std::begin(c)), sentinel(std::end(c)),
...
void test_search4_sentinel(ExPolicy policy, IteratorTag)
{
    ...
    iterator index = pika::ranges::search(policy, iterator(std::begin(c)),
...
void test_search4(ExPolicy policy, IteratorTag)
{
    ...
    auto index = pika::ranges::search(policy, c, h, op);
...
void test_search4_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::ranges::search(p, c, h, op);
    f.wait();
...
void test_search5(ExPolicy policy, IteratorTag)
{
    ...
    auto index = pika::ranges::search(policy, c, h, op, proj1, proj2);
    auto test_index = std::begin(c) + c.size() / 2;
...
void test_search5_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::ranges::search(p, c, h, op, proj1, proj2);
    f.wait();
