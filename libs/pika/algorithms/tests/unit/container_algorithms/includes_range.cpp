...
void test_includes1(IteratorTag)
{
    ...
    {
        bool result = pika::ranges::includes(
...

    {
        ...
        if (!c2.empty())
        {
            ...
            bool result = pika::ranges::includes(iterator(std::begin(c1)),
...
void test_includes1(ExPolicy&& policy, IteratorTag)
{
    ...
    {
        bool result = pika::ranges::includes(policy, iterator(std::begin(c1)),
...

    {
        ...
        if (!c2.empty())
        {
            ...
            bool result =
                pika::ranges::includes(policy, iterator(std::begin(c1)),
                    iterator(std::end(c1)), std::begin(c2), std::end(c2));
...
void test_includes1_async(ExPolicy&& p, IteratorTag)
{
    ...
    {
        pika::future<bool> result = pika::ranges::includes(p,
            iterator(std::begin(c1)), iterator(std::end(c1)), start_it, end_it);
        result.wait();
...

    {
        ...
        if (!c2.empty())
        {
            ...
            pika::future<bool> result =
                pika::ranges::includes(p, iterator(std::begin(c1)),
                    iterator(std::end(c1)), std::begin(c2), std::end(c2));
            result.wait();
...
void test_includes2(ExPolicy&& policy, IteratorTag)
{
...

    {
        ...
        if (!c2.empty())
        {
            ...
            bool result = pika::ranges::includes(policy,
...
void test_includes_exception(IteratorTag)
{
    ...
    try
    {
        pika::ranges::includes(iterator(std::begin(c1)), iterator(std::end(c1)),
