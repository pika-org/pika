...
void test_find_end1(IteratorTag)
{
    ...
    base_iterator index = pika::ranges::find_end(c, h);
...
void test_find_end1(ExPolicy&& policy, IteratorTag)
{
    ...
    base_iterator index = pika::ranges::find_end(policy, c, h);
...
void test_find_end1_async(ExPolicy&& p, IteratorTag)
{
    ...
    pika::future<base_iterator> f = pika::ranges::find_end(p, c, h);
    f.wait();
...
void test_find_end2_proj(IteratorTag)
{
    ...
    base_iterator index =
        pika::ranges::find_end(c, h, std::equal_to<std::size_t>(), proj, proj);
...
void test_find_end2_proj(ExPolicy&& policy, IteratorTag)
{
    ...
    base_iterator index = pika::ranges::find_end(
...
void test_find_end2_async_proj(ExPolicy&& p, IteratorTag)
{
    ...
    pika::future<base_iterator> f = pika::ranges::find_end(
