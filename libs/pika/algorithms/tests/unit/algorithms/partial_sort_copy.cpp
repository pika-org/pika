...
void test_partial_sort_copy1(IteratorTag)
{
    ...
    pika::partial_sort_copy(l.begin(), l.end(), &v1[0], &v1[4]);
    ...
    pika::partial_sort_copy(l.begin(), l.end(), &v1[0], &v1[9]);
    ...
    pika::partial_sort_copy(l.begin(), l.end(), &v1[0], &v1[20]);
...
void test_partial_sort_copy1(ExPolicy policy, IteratorTag)
{
    ...
    pika::partial_sort_copy(policy, l.begin(), l.end(), &v1[0], &v1[4]);
    std::partial_sort_copy(l.begin(), l.end(), &v2[0], &v2[4]);
    ...
    pika::partial_sort_copy(policy, l.begin(), l.end(), &v1[0], &v1[9]);
    std::partial_sort_copy(l.begin(), l.end(), &v2[0], &v2[9]);
    ...
    pika::partial_sort_copy(policy, l.begin(), l.end(), &v1[0], &v1[20]);
    std::partial_sort_copy(l.begin(), l.end(), &v2[0], &v2[20]);
...
void test_partial_sort_copy1_async(ExPolicy p, IteratorTag)
{
    ...
    auto f1 = pika::partial_sort_copy(
    ...
    auto f2 =
        pika::partial_sort_copy(p, l.begin(), l.end(), v1.begin(), v1.end());
    f2.wait();
...
void test_partial_sort_copy2(ExPolicy policy, IteratorTag)
{
    ...
    for (std::uint64_t i = 0; i <= NELEM; ++i)
    {
        ...
        pika::partial_sort_copy(policy, lst.begin(), lst.end(), A.begin(),
            A.begin() + i, compare_t());
