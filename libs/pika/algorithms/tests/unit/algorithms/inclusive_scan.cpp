...
void inclusive_scan_validate()
{
    ...
    test_inclusive_scan_validate(pika::execution::seq, a, b);
    test_inclusive_scan_validate(pika::execution::par, a, b);
    // test scan algorithms using same array for input and output
    //  std::cout << " Validating in_place arrays " <<std::endl;
    test_inclusive_scan_validate(pika::execution::seq, a, a);
    test_inclusive_scan_validate(pika::execution::par, a, a);
}
