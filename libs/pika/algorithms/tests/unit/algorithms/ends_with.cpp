...
void test_ends_with(IteratorTag)
{
    ...
    auto result1 = pika::ends_with(std::begin(some_ints), std::end(some_ints),
        std::begin(some_more_ints), std::end(some_more_ints));
    PIKA_TEST_EQ(result1, true);

    auto result2 = pika::ends_with(std::begin(some_ints), std::end(some_ints),
...
void test_ends_with(ExPolicy policy, IteratorTag)
{
    ...
    auto result1 =
        pika::ends_with(policy, std::begin(some_ints), std::end(some_ints),
            std::begin(some_more_ints), std::end(some_more_ints));
    PIKA_TEST_EQ(result1, true);
...
void test_ends_with_async(ExPolicy p, IteratorTag)
{
    ...
    pika::future<bool> result1 =
        pika::ends_with(p, std::begin(some_ints), std::end(some_ints),
            std::begin(some_more_ints), std::end(some_more_ints));
    result1.wait();
