...
void test_rotate_copy(IteratorTag)
{
    ...
    pika::rotate_copy(iterator(std::begin(c)), iterator(mid),
...
void test_rotate_copy(ExPolicy policy, IteratorTag)
{
    ...
    pika::rotate_copy(policy, iterator(std::begin(c)), iterator(mid),
        iterator(std::end(c)), std::begin(d1));
...
void test_rotate_copy_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::rotate_copy(p, iterator(std::begin(c)), iterator(mid),
        iterator(std::end(c)), std::begin(d1));
    f.wait();
...
void test_rotate_copy_exception(IteratorTag)
{
    ...
    try
    {
        pika::rotate_copy(decorated_iterator(std::begin(c),
