...
void test3()
{
    ...
    PIKA_TEST(RB.begin() == RB.end());
    RA = rng(A.begin(), A.end());
    Rx = RA;
    Rz = half_merge(Rx, RB, RA, comp);
    PIKA_TEST(Rz.size() == 10);
    for (std::uint32_t i = 0; i < 10; ++i)
        PIKA_TEST(*(Rz.begin() + i) == i);
...
void test4()
{
    ...
    Rx = rng(A.begin(), A.end());
    Rz = half_merge(Rx, RB, RA, comp);
    PIKA_TEST(Rz.size() == 200);

    for (std::uint32_t i = 0; i < 50; ++i)
        PIKA_TEST(A[i].num == i && A[i].tail == 0);
    for (std::uint32_t i = 50; i < 150; ++i)
    {
        std::uint32_t K = i + 50;
        std::uint32_t M = K % 2;
        PIKA_TEST(A[i].num == K - M && A[i].tail == M);
    }
    for (std::uint32_t i = 150; i < 200; ++i)
        PIKA_TEST(A[i].num == 2 * i - 100 && A[i].tail == 1);
    ...
    for (std::uint32_t i = 0; i < 50; ++i)
        PIKA_TEST(A[i].num == i && A[i].tail == 1);
    for (std::uint32_t i = 50; i < 150; ++i)
    {
        std::uint32_t K = i + 50;
        std::uint32_t M = K % 2;
    ...
    for (std::uint32_t i = 150; i < 200; ++i)
        PIKA_TEST(A[i].num == 2 * i - 100 && A[i].tail == 0);
}
...
void test7()
{
    ...
    for (std::uint32_t i = 0; i < 50; ++i)
        PIKA_TEST(B[i].num == i && B[i].tail == 0);
    for (std::uint32_t i = 50; i < 150; ++i)
    {
        std::uint32_t K = i + 50;
        std::uint32_t M = K % 2;
        PIKA_TEST(B[i].num == K - M && B[i].tail == M);
    }
    for (std::uint32_t i = 150; i < 200; ++i)
        PIKA_TEST(B[i].num == 2 * i - 100 && B[i].tail == 1);
    ...
    for (std::uint32_t i = 0; i < 50; ++i)
        PIKA_TEST(B[i].num == i && B[i].tail == 1);
    for (std::uint32_t i = 50; i < 150; ++i)
    {
        std::uint32_t K = i + 50;
        std::uint32_t M = K % 2;
    ...
    for (std::uint32_t i = 150; i < 200; ++i)
        PIKA_TEST(B[i].num == 2 * i - 100 && B[i].tail == 0);
}
