...
void test_none_of(IteratorTag)
{
    ...
    for (int i : iseq)
    {
        ...
        bool result = pika::none_of(iterator(std::begin(c)),
...
void test_none_of(ExPolicy&& policy, IteratorTag)
{
    ...
    for (int i : iseq)
    {
        ...
        bool result = pika::none_of(policy, iterator(std::begin(c)),
            iterator(std::end(c)), [](auto v) { return v != 0; });
...
void test_none_of_ranges_seq(IteratorTag, Proj proj = Proj())
{
    ...
    for (int i : iseq)
    {
        ...
        bool result = pika::ranges::none_of(
...
void test_none_of_async(ExPolicy&& p, IteratorTag)
{
    ...
    for (int i : iseq)
    {
        ...
        pika::future<bool> f = pika::none_of(p, iterator(std::begin(c)),
            iterator(std::end(c)), [](auto v) { return v != 0; });
        f.wait();
...
void test_none_of_ranges_async(ExPolicy&& p, IteratorTag, Proj proj = Proj())
{
    ...
    for (int i : iseq)
    {
        ...
        pika::future<bool> f = pika::ranges::none_of(
...
void test_none_of_exception_async(ExPolicy&& p, IteratorTag)
{
    ...
    for (int i : iseq)
    {
        ...
        try
        {
            pika::future<void> f = pika::none_of(
...
void test_none_of_bad_alloc_async(ExPolicy&& p, IteratorTag)
{
    ...
    for (int i : iseq)
    {
        ...
        {
            pika::future<void> f =
                pika::none_of(p, iterator(std::begin(c)), iterator(std::end(c)),
                    [](auto v) { return throw std::bad_alloc(), v != 0; });
            returned_from_algorithm = true;
            f.get();
