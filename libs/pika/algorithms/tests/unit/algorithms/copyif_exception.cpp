...
void test_copy_if_exception(IteratorTag)
{
    ...
    try
    {
        pika::copy_if(iterator(std::begin(c)), iterator(std::end(c)),
...
void test_copy_if_exception()
{
    ...
    test_copy_if_exception(pika::execution::seq, IteratorTag());
    test_copy_if_exception(pika::execution::par, IteratorTag());
