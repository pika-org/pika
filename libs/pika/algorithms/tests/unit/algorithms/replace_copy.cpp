...
void test_replace_copy(IteratorTag)
{
    ...
    pika::replace_copy(iterator(std::begin(c)), iterator(std::end(c)),
...
void test_replace_copy(ExPolicy policy, IteratorTag)
{
    ...
    pika::replace_copy(policy, iterator(std::begin(c)), iterator(std::end(c)),
        std::begin(d1), c[idx], c[idx] + 1);
...
void test_replace_copy_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::replace_copy(p, iterator(std::begin(c)),
