...
void test_reverse(IteratorTag)
{
    ...
    pika::reverse(iterator(std::begin(c)), iterator(std::end(c)));
...
void test_reverse(ExPolicy policy, IteratorTag)
{
    ...
    pika::reverse(policy, iterator(std::begin(c)), iterator(std::end(c)));
...
void test_reverse_async(ExPolicy p, IteratorTag)
{
    ...
    auto f = pika::reverse(p, iterator(std::begin(c)), iterator(std::end(c)));
    f.wait();
...
void test_reverse_exception(IteratorTag)
{
    ...
    try
    {
        pika::reverse(decorated_iterator(std::begin(c)),
            decorated_iterator(
...
void test_reverse_exception(ExPolicy policy, IteratorTag)
{
    ...
    try
    {
        pika::reverse(policy, decorated_iterator(std::begin(c)),
            decorated_iterator(
                std::end(c), []() { throw std::runtime_error("test"); }));
        PIKA_TEST(false);
    }
