...
void cuda_trivial_kernel(T t, cudaStream_t stream)
{
    ...
    ::pika::cuda::experimental::check_cuda_error(cudaDeviceSynchronize());
#else
...
#pragma clang diagnostic ignored "-Wuninitialized"
    ...
    PIKA_ASSERT(*out == t);
    ::pika::cuda::experimental::check_cuda_error(cudaFree(d_in));
    ::pika::cuda::experimental::check_cuda_error(cudaFree(d_out));
    free(out);
#if defined(__clang__)
