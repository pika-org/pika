...
{
    {
        ...
        auto& hpstream1 = pool.get_next_stream(pika::execution::thread_priority::high);
        auto& hpstream2 = pool.get_next_stream(pika::execution::thread_priority::high);
        auto& hpstream3 = pool.get_next_stream(pika::execution::thread_priority::high);
...

    {
        ...
        auto& hpstream2 = pool.get_next_stream(pika::execution::thread_priority::high);
        auto& hpstream3 = pool.get_next_stream(pika::execution::thread_priority::high);
        auto& hpstream4 = pool.get_next_stream(pika::execution::thread_priority::high);
