...
{
    {
        pika::util::streamable_unique_any_nonser any1(big_object(30, 40));
    ...
    // non serializable version
    {
        // test equality
        {
            pika::unique_any_nonser any1_nonser(7), any2_nonser(7),
            ...
            PIKA_TEST_EQ(pika::any_cast<std::string>(any2_nonser), long_str);
            PIKA_TEST_NEQ(pika::any_cast<std::string>(any2_nonser), other_str);
            PIKA_TEST(any2_nonser.type() == typeid(std::string));
            PIKA_TEST(pika::any_cast<std::string>(any2_nonser) ==
                pika::any_cast<std::string>(any2_nonser));
            PIKA_TEST(any2_nonser.type() == any3_nonser.type());
            PIKA_TEST(any2_nonser.type() != any4_nonser.type());
        }

        {
            ...
            pika::unique_any_nonser any1_nonser(f);
            pika::unique_any_nonser any2_nonser(std::move(any1_nonser));
            PIKA_TEST(!any1_nonser.has_value());    // NOLINT

            pika::unique_any_nonser any3_nonser(f);
            pika::unique_any_nonser any4_nonser = std::move(any3_nonser);
            PIKA_TEST(!any3_nonser.has_value());    // NOLINT

            PIKA_TEST_EQ((pika::any_cast<small_object>(any2_nonser))(4),
                uint64_t(17 + 4));
            PIKA_TEST_EQ((pika::any_cast<small_object>(any4_nonser))(6),
                uint64_t(17 + 6));
        }

        {
            ...
            PIKA_TEST_EQ((pika::any_cast<big_object>(any2_nonser))(5, 6),
                uint64_t(5 + 12 + 5 + 6));
            PIKA_TEST_EQ((pika::any_cast<big_object>(any4_nonser))(7, 8),
                uint64_t(5 + 12 + 7 + 8));
        }

        // move semantics
        {
            pika::unique_any_nonser any1(5);
            PIKA_TEST(any1.has_value());
            pika::unique_any_nonser any2(std::move(any1));
