...
// pika-no-inspect : disable automatic code inspection for this file
// clang-format off
...
#define PIKA_VARIANT_ALWAYS_INLINE __attribute__((__always_inline__)) inline
#elif defined(_MSC_VER)
#define PIKA_VARIANT_ALWAYS_INLINE __forceinline
#else
#define PIKA_VARIANT_ALWAYS_INLINE inline
#endif

#if __has_builtin(__builtin_addressof) || \
    (defined(__GNUC__) && __GNUC__ >= 7) || defined(_MSC_VER)
#define PIKA_VARIANT_BUILTIN_ADDRESSOF
#endif

#if __has_builtin(__builtin_unreachable) || defined(__GNUC__)
#define PIKA_VARIANT_BUILTIN_UNREACHABLE __builtin_unreachable()
#elif defined(_MSC_VER)
#define PIKA_VARIANT_BUILTIN_UNREACHABLE __assume(false)
#else
#define PIKA_VARIANT_BUILTIN_UNREACHABLE
#endif

#if __has_builtin(__type_pack_element)
#define PIKA_VARIANT_TYPE_PACK_ELEMENT
#endif

#if defined(__cpp_constexpr) && __cpp_constexpr >= 200704 && \
    !(defined(__GNUC__) && __GNUC__ == 4 && __GNUC_MINOR__ == 9)
#define PIKA_VARIANT_CPP11_CONSTEXPR
#endif

#if defined(__cpp_constexpr) && __cpp_constexpr >= 201304
#define PIKA_VARIANT_CPP14_CONSTEXPR
#endif

#if __has_feature(cxx_exceptions) || defined(__cpp_exceptions) || \
    (defined(_MSC_VER) && defined(_CPPUNWIND))
#define PIKA_VARIANT_EXCEPTIONS
#endif

#if defined(__cpp_generic_lambdas) || defined(_MSC_VER)
#define PIKA_VARIANT_GENERIC_LAMBDAS
#endif

#if defined(__cpp_lib_integer_sequence)
#define PIKA_VARIANT_INTEGER_SEQUENCE
#endif

#if defined(__cpp_return_type_deduction) || defined(_MSC_VER)
#define PIKA_VARIANT_RETURN_TYPE_DEDUCTION
#endif

#if defined(__cpp_lib_transparent_operators) || defined(_MSC_VER)
#define PIKA_VARIANT_TRANSPARENT_OPERATORS
#endif

#if defined(__cpp_variable_templates) || defined(_MSC_VER)
#define PIKA_VARIANT_VARIABLE_TEMPLATES
#endif

#if !defined(__GLIBCXX__) || __has_include(<codecvt>)  // >= libstdc++-5
#define PIKA_VARIANT_TRIVIALITY_TYPE_TRAITS
#define PIKA_VARIANT_INCOMPLETE_TYPE_TRAITS
#endif
...
#ifdef PIKA_VARIANT_VARIABLE_TEMPLATES
...
namespace pika { namespace variant_ns {
  namespace lib {
    ...
    inline namespace cpp14 {
...
#ifdef PIKA_VARIANT_INTEGER_SEQUENCE
      ...
      // <functional>
#ifdef PIKA_VARIANT_TRANSPARENT_OPERATORS
      ...
      namespace detail {
        ...
        struct Invoke<true /* pmf */, 0 /* is_base_of */> {
          ...
          inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&... args)
            PIKA_VARIANT_RETURN((lib::forward<Arg>(arg).*pmf)(lib::forward<Args>(args)...))
        };
        ...
        struct Invoke<true /* pmf */, 1 /* is_reference_wrapper */> {
          template <typename R, typename T, typename Arg, typename... Args>
          inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&... args)
            PIKA_VARIANT_RETURN((lib::forward<Arg>(arg).get().*pmf)(lib::forward<Args>(args)...))
        };
        ...
        struct Invoke<false /* pmo */, 0 /* is_base_of */> {
          ...
          inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
            PIKA_VARIANT_RETURN(lib::forward<Arg>(arg).*pmo)
        };
        ...
        struct Invoke<false /* pmo */, 1 /* is_reference_wrapper */> {
          template <typename R, typename T, typename Arg>
          inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
            PIKA_VARIANT_RETURN(lib::forward<Arg>(arg).get().*pmo)
        };
...
#pragma warning(disable : 4100)
        ...
        inline constexpr auto invoke(F &&f, Args &&... args)
          PIKA_VARIANT_RETURN(lib::forward<F>(f)(lib::forward<Args>(args)...))
#ifdef _MSC_VER
#pragma warning(pop)
#endif
      }  // namespace detail
      ...
      template <typename F, typename... Args>
      inline constexpr auto invoke(F &&f, Args &&... args)
        PIKA_VARIANT_RETURN(detail::invoke(lib::forward<F>(f),
                                    lib::forward<Args>(args)...))
      ...
      // <memory>
#ifdef PIKA_VARIANT_BUILTIN_ADDRESSOF
      template <typename T>
...
#ifdef PIKA_VARIANT_TYPE_PACK_ELEMENT
...
#ifdef PIKA_VARIANT_TRIVIALITY_TYPE_TRAITS
...
#ifdef PIKA_VARIANT_EXCEPTIONS
    throw bad_variant_access{};
#else
    std::terminate();
    PIKA_VARIANT_BUILTIN_UNREACHABLE;
#endif
  }
...
#ifdef PIKA_VARIANT_CPP14_CONSTEXPR
...
#if defined(PIKA_VARIANT_CPP14_CONSTEXPR) && !defined(_MSC_VER)
#define PIKA_VARIANT_VARIANT_SWITCH_VISIT
#endif
      ...
      struct base {
...
#ifdef PIKA_VARIANT_VARIANT_SWITCH_VISIT
        ...
        struct dispatcher<false, R, ITs...> {
          ...
          PIKA_VARIANT_ALWAYS_INLINE static constexpr R dispatch(
              F &&, typename ITs::type &&..., Vs &&...) {
            PIKA_VARIANT_BUILTIN_UNREACHABLE;
          }

          template <std::size_t I, typename F, typename... Vs>
          PIKA_VARIANT_ALWAYS_INLINE static constexpr R dispatch_case(F &&, Vs &&...) {
            PIKA_VARIANT_BUILTIN_UNREACHABLE;
          }

          template <std::size_t B, typename F, typename... Vs>
          PIKA_VARIANT_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t,
                                                             F &&,
                                                             Vs &&...) {
            PIKA_VARIANT_BUILTIN_UNREACHABLE;
          }
...
#define PIKA_VARIANT_DISPATCH(I)                                                   \
...
#define PIKA_VARIANT_DEFAULT(I)                                                      \
  dispatcher<(I < lib::decay_t<V>::size()), R, ITs...>::template dispatch<I>( \
      ...
      lib::forward<Vs>(vs)...)
            ...
            switch (v.index()) {
              case B + 0: return PIKA_VARIANT_DISPATCH(B + 0);
              case B + 1: return PIKA_VARIANT_DISPATCH(B + 1);
              case B + 2: return PIKA_VARIANT_DISPATCH(B + 2);
              case B + 3: return PIKA_VARIANT_DISPATCH(B + 3);
              case B + 4: return PIKA_VARIANT_DISPATCH(B + 4);
              case B + 5: return PIKA_VARIANT_DISPATCH(B + 5);
              case B + 6: return PIKA_VARIANT_DISPATCH(B + 6);
              case B + 7: return PIKA_VARIANT_DISPATCH(B + 7);
              case B + 8: return PIKA_VARIANT_DISPATCH(B + 8);
              case B + 9: return PIKA_VARIANT_DISPATCH(B + 9);
              case B + 10: return PIKA_VARIANT_DISPATCH(B + 10);
              case B + 11: return PIKA_VARIANT_DISPATCH(B + 11);
              case B + 12: return PIKA_VARIANT_DISPATCH(B + 12);
              case B + 13: return PIKA_VARIANT_DISPATCH(B + 13);
              case B + 14: return PIKA_VARIANT_DISPATCH(B + 14);
              case B + 15: return PIKA_VARIANT_DISPATCH(B + 15);
              case B + 16: return PIKA_VARIANT_DISPATCH(B + 16);
              case B + 17: return PIKA_VARIANT_DISPATCH(B + 17);
              case B + 18: return PIKA_VARIANT_DISPATCH(B + 18);
              case B + 19: return PIKA_VARIANT_DISPATCH(B + 19);
              case B + 20: return PIKA_VARIANT_DISPATCH(B + 20);
              case B + 21: return PIKA_VARIANT_DISPATCH(B + 21);
              case B + 22: return PIKA_VARIANT_DISPATCH(B + 22);
              case B + 23: return PIKA_VARIANT_DISPATCH(B + 23);
              case B + 24: return PIKA_VARIANT_DISPATCH(B + 24);
              case B + 25: return PIKA_VARIANT_DISPATCH(B + 25);
              case B + 26: return PIKA_VARIANT_DISPATCH(B + 26);
              case B + 27: return PIKA_VARIANT_DISPATCH(B + 27);
              case B + 28: return PIKA_VARIANT_DISPATCH(B + 28);
              case B + 29: return PIKA_VARIANT_DISPATCH(B + 29);
              case B + 30: return PIKA_VARIANT_DISPATCH(B + 30);
              case B + 31: return PIKA_VARIANT_DISPATCH(B + 31);
              default: return PIKA_VARIANT_DEFAULT(B + 32);
            }

#undef PIKA_VARIANT_DEFAULT
#undef PIKA_VARIANT_DISPATCH
          }

          template <std::size_t I, typename F, typename... Vs>
          PIKA_VARIANT_ALWAYS_INLINE static constexpr R dispatch_case(F &&f,
                                                               Vs &&... vs) {
            using Expected = R;
          ...
          template <std::size_t B, typename F, typename V, typename... Vs>
          PIKA_VARIANT_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t index,
                                                             F &&f,
                                                             V &&v,
                                                             Vs &&... vs) {
...
#define PIKA_VARIANT_DISPATCH_AT(I)                                               \
...
#define PIKA_VARIANT_DEFAULT(I)                                                 \
  dispatcher<(I < lib::decay_t<V>::size()), R>::template dispatch_at<I>( \
      index, lib::forward<F>(f), lib::forward<V>(v), lib::forward<Vs>(vs)...)
            ...
            switch (index) {
              case B + 0: return PIKA_VARIANT_DISPATCH_AT(B + 0);
              case B + 1: return PIKA_VARIANT_DISPATCH_AT(B + 1);
              case B + 2: return PIKA_VARIANT_DISPATCH_AT(B + 2);
              case B + 3: return PIKA_VARIANT_DISPATCH_AT(B + 3);
              case B + 4: return PIKA_VARIANT_DISPATCH_AT(B + 4);
              case B + 5: return PIKA_VARIANT_DISPATCH_AT(B + 5);
              case B + 6: return PIKA_VARIANT_DISPATCH_AT(B + 6);
              case B + 7: return PIKA_VARIANT_DISPATCH_AT(B + 7);
              case B + 8: return PIKA_VARIANT_DISPATCH_AT(B + 8);
              case B + 9: return PIKA_VARIANT_DISPATCH_AT(B + 9);
              case B + 10: return PIKA_VARIANT_DISPATCH_AT(B + 10);
              case B + 11: return PIKA_VARIANT_DISPATCH_AT(B + 11);
              case B + 12: return PIKA_VARIANT_DISPATCH_AT(B + 12);
              case B + 13: return PIKA_VARIANT_DISPATCH_AT(B + 13);
              case B + 14: return PIKA_VARIANT_DISPATCH_AT(B + 14);
              case B + 15: return PIKA_VARIANT_DISPATCH_AT(B + 15);
              case B + 16: return PIKA_VARIANT_DISPATCH_AT(B + 16);
              case B + 17: return PIKA_VARIANT_DISPATCH_AT(B + 17);
              case B + 18: return PIKA_VARIANT_DISPATCH_AT(B + 18);
              case B + 19: return PIKA_VARIANT_DISPATCH_AT(B + 19);
              case B + 20: return PIKA_VARIANT_DISPATCH_AT(B + 20);
              case B + 21: return PIKA_VARIANT_DISPATCH_AT(B + 21);
              case B + 22: return PIKA_VARIANT_DISPATCH_AT(B + 22);
              case B + 23: return PIKA_VARIANT_DISPATCH_AT(B + 23);
              case B + 24: return PIKA_VARIANT_DISPATCH_AT(B + 24);
              case B + 25: return PIKA_VARIANT_DISPATCH_AT(B + 25);
              case B + 26: return PIKA_VARIANT_DISPATCH_AT(B + 26);
              case B + 27: return PIKA_VARIANT_DISPATCH_AT(B + 27);
              case B + 28: return PIKA_VARIANT_DISPATCH_AT(B + 28);
              case B + 29: return PIKA_VARIANT_DISPATCH_AT(B + 29);
              case B + 30: return PIKA_VARIANT_DISPATCH_AT(B + 30);
              case B + 31: return PIKA_VARIANT_DISPATCH_AT(B + 31);
              default: return PIKA_VARIANT_DEFAULT(B + 32);
            }

#undef PIKA_VARIANT_DEFAULT
#undef PIKA_VARIANT_DISPATCH_AT
          }
        };
#else
        template <typename T>
...
#if !defined(PIKA_VARIANT_VARIANT_SWITCH_VISIT) && \
...
#define PIKA_VARIANT_VARIANT_RECURSIVE_UNION(destructible_trait, destructor)      \
  ...
  union recursive_union<destructible_trait, Index, T, Ts...> {             \
    ...
    PIKA_VARIANT_VARIANT_RECURSIVE_UNION(Trait::TriviallyAvailable,
                                  ~recursive_union() = default;);
    PIKA_VARIANT_VARIANT_RECURSIVE_UNION(Trait::Available,
                                  ~recursive_union() {});
    PIKA_VARIANT_VARIANT_RECURSIVE_UNION(Trait::Unavailable,
                                  ~recursive_union() = delete;);

#undef PIKA_VARIANT_VARIANT_RECURSIVE_UNION
...
#define PIKA_VARIANT_INHERITING_CTOR(type, base) using base::base;
#else
#define PIKA_VARIANT_INHERITING_CTOR(type, base)         \
  template <typename... Args>                     \
...
#define PIKA_VARIANT_VARIANT_DESTRUCTOR(destructible_trait, definition, destroy) \
  template <typename... Ts>                                               \
  class destructor<traits<Ts...>, destructible_trait>                     \
    ...
    using super = base<destructible_trait, Ts...>;                        \
                                                                          \
    public:                                                               \
    PIKA_VARIANT_INHERITING_CTOR(destructor, super)                              \
    ...
    PIKA_VARIANT_VARIANT_DESTRUCTOR(
        Trait::TriviallyAvailable,
        ~destructor() = default;,
...
#undef PIKA_VARIANT_VARIANT_DESTRUCTOR
    ...
    class constructor : public destructor<Traits> {
      ...
      public:
      PIKA_VARIANT_INHERITING_CTOR(constructor, super)
      using super::operator=;
      ...
      inline static void generic_construct(constructor &lhs, Rhs &&rhs) {
        ...
        if (!rhs.valueless_by_exception()) {
          visitation::alt::visit_alt_at(
              rhs.index(),
#ifdef PIKA_VARIANT_GENERIC_LAMBDAS
...
#define PIKA_VARIANT_VARIANT_MOVE_CONSTRUCTOR(move_constructible_trait, definition) \
  template <typename... Ts>                                                  \
  class move_constructor<traits<Ts...>, move_constructible_trait>            \
    ...
    using super = constructor<traits<Ts...>>;                                \
                                                                             \
    public:                                                                  \
    PIKA_VARIANT_INHERITING_CTOR(move_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    ...
    PIKA_VARIANT_VARIANT_MOVE_CONSTRUCTOR(
        Trait::TriviallyAvailable,
...
#undef PIKA_VARIANT_VARIANT_MOVE_CONSTRUCTOR

    template <typename Traits, Trait = Traits::copy_constructible_trait>
    class copy_constructor;

#define PIKA_VARIANT_VARIANT_COPY_CONSTRUCTOR(copy_constructible_trait, definition) \
  template <typename... Ts>                                                  \
  class copy_constructor<traits<Ts...>, copy_constructible_trait>            \
    ...
    using super = move_constructor<traits<Ts...>>;                           \
                                                                             \
    public:                                                                  \
    PIKA_VARIANT_INHERITING_CTOR(copy_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    definition                                                               \
    ...
    PIKA_VARIANT_VARIANT_COPY_CONSTRUCTOR(
        Trait::TriviallyAvailable,
...
#undef PIKA_VARIANT_VARIANT_COPY_CONSTRUCTOR
    ...
    class assignment : public copy_constructor<Traits> {
      ...
      public:
      PIKA_VARIANT_INHERITING_CTOR(assignment, super)
      using super::operator=;
...
#define PIKA_VARIANT_VARIANT_MOVE_ASSIGNMENT(move_assignable_trait, definition) \
  template <typename... Ts>                                              \
  class move_assignment<traits<Ts...>, move_assignable_trait>            \
    ...
    using super = assignment<traits<Ts...>>;                             \
                                                                         \
    public:                                                              \
    PIKA_VARIANT_INHERITING_CTOR(move_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
    ...
    PIKA_VARIANT_VARIANT_MOVE_ASSIGNMENT(
        Trait::TriviallyAvailable,
...
#undef PIKA_VARIANT_VARIANT_MOVE_ASSIGNMENT

    template <typename Traits, Trait = Traits::copy_assignable_trait>
    class copy_assignment;

#define PIKA_VARIANT_VARIANT_COPY_ASSIGNMENT(copy_assignable_trait, definition) \
  template <typename... Ts>                                              \
  class copy_assignment<traits<Ts...>, copy_assignable_trait>            \
    ...
    using super = move_assignment<traits<Ts...>>;                        \
                                                                         \
    public:                                                              \
    PIKA_VARIANT_INHERITING_CTOR(copy_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
    ...
    PIKA_VARIANT_VARIANT_COPY_ASSIGNMENT(
        Trait::TriviallyAvailable,
...
#undef PIKA_VARIANT_VARIANT_COPY_ASSIGNMENT
    ...
    class impl : public copy_assignment<traits<Ts...>> {
      ...
      public:
      PIKA_VARIANT_INHERITING_CTOR(impl, super)
      using super::operator=;
...
#undef PIKA_VARIANT_INHERITING_CTOR
...
namespace std {
  ...
  template <typename... Ts>
  struct hash<pika::variant_ns::detail::enabled_type<
      pika::variant_ns::variant<Ts...>,
      pika::variant_ns::lib::enable_if_t<
          pika::variant_ns::lib::all<
              pika::variant_ns::detail::hash::is_enabled<
              pika::variant_ns::lib::remove_const_t<Ts>>()...>::value>>> {
...
#ifdef PIKA_VARIANT_GENERIC_LAMBDAS
                    [](const auto &alt) {
                      using alt_type = pika::variant_ns::lib::decay_t<decltype(alt)>;
                      using value_type = pika::variant_ns::lib::remove_const_t<
  ...
  template <>
  struct hash<pika::variant_ns::monostate> {
