...
namespace pika { namespace util { namespace detail { namespace any {
    ...
    struct fxn_ptr_table<IArch, OArch, Char, std::true_type>
    {
        ...
        PIKA_SERIALIZATION_POLYMORPHIC_ABSTRACT(fxn_ptr_table);
    };
      ...
      : fxn_ptr_table<IArch, OArch, Char, std::true_type>
    {
        ...
        {
            // clang-format off
            ar & pika::serialization::base_object<base_type>(*this);
            // clang-format on
        }
        PIKA_SERIALIZATION_POLYMORPHIC_TEMPLATE(fxn_ptr);
    };
    ...
    private:
        ...
        void load(IArch& ar, const unsigned version)
        {
            ...
            else
            {
                ...
                ar >> pika::serialization::detail::raw_ptr(p);
        ...
        void save(OArch& ar, const unsigned version) const
        {
            ...
            if (!is_empty)
            {
                ar << pika::serialization::detail::raw_ptr(table);
