...
{
    {
        ...
        iarchive >> icomplex;
        PIKA_TEST_EQ(ocomplex.real(), icomplex.real());
        PIKA_TEST_EQ(ocomplex.imag(), icomplex.imag());
    }
    {
        std::vector<char> buffer;
        pika::serialization::output_archive oarchive(buffer);
        ...
        iarchive >> icomplex;
        PIKA_TEST_EQ(ocomplex.t_.real(), icomplex.t_.real());
        PIKA_TEST_EQ(ocomplex.t_.imag(), icomplex.t_.imag());
    }
}
