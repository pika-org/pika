...
namespace any_tests    // test definitions
{
    ...
    {
        std::string text = "test message";
        pika::any original = pika::any(text), copy = pika::any(original);
    ...
    {
        std::string text = "test message";
        pika::any original = pika::any(text), copy;
        pika::any* assign_result = &(copy = original);
    ...
    void test_converting_assign()
    {
        std::string text = "test message";
        pika::any value;
        pika::any* assign_result = &(value = text);
    ...
    void test_swap_small()
    {
        ...
        pika::any original = pika::any(text), swapped;
        small_object* original_ptr = pika::any_cast<small_object>(&original);
        pika::any* swap_result = &original.swap(swapped);
        ...
        pika::any copy1 = pika::any(copy_counter());
        pika::any copy2 = pika::any(copy_counter());
