...
//  SPDX-License-Identifier: BSL-1.0
    ...
    The class pika::any is built based on boost::spirit::hold_any class. It adds
...
namespace pika { namespace util {
    ...
    namespace detail {
        ...
        struct hash_binary_filter : serialization::binary_filter
        {
            ...
            PIKA_SERIALIZATION_POLYMORPHIC(hash_binary_filter);
    ...
    template PIKA_EXPORT std::size_t hash_any::operator()(
        const basic_any<serialization::input_archive,
            serialization::output_archive, char, std::true_type>& elem) const;

    template PIKA_EXPORT std::size_t
