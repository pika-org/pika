...
*/
    ...
    {
        PIKA_EXPORT static std::unique_ptr<cout> make();
...
*/
    ...
    {
        PIKA_EXPORT static std::unique_ptr<cerr> make();
...
*/
    ...
    {
        PIKA_EXPORT static std::unique_ptr<dbg_window> make();

        PIKA_EXPORT ~dbg_window();
