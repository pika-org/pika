...
struct receiver
{
    ...
    friend constexpr ex::detail::empty_env tag_invoke(ex::get_env_t, receiver const&) noexcept
    {
        return {};
    }
...
struct void_receiver
{
    ...
    friend constexpr ex::detail::empty_env tag_invoke(ex::get_env_t, void_receiver const&) noexcept
    {
        return {};
    }
};
