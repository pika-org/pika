...
namespace mylib {
    struct receiver_1
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, receiver_1&&) noexcept
        {
            done_called = true;
        }
        ...
        friend void tag_invoke(
            pika::execution::experimental::set_value_t, receiver_1&&, int)
        {
            value_called = true;
        }
    };
    ...
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, receiver_2&&) noexcept
        {
            done_called = true;
        }
    ...
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, receiver_3&&) noexcept
        {
            done_called = true;
        }
    ...
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, non_receiver_1&) noexcept
        {
            done_called = true;
        }
    ...
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, non_receiver_3&) noexcept
        {
            done_called = true;
        }
    ...
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, non_receiver_5&&)
        {
            done_called = true;
        }
    ...
    {
        friend void tag_invoke(
            pika::execution::experimental::set_done_t, non_receiver_7&&)
        {
            done_called = true;
        }
...
int main()
{
    using pika::execution::experimental::is_nothrow_receiver_of;
    using pika::execution::experimental::is_receiver;
    using pika::execution::experimental::is_receiver_of;
...

    {
        ...
        pika::execution::experimental::set_done(std::move(rcv));
    ...
    {
        mylib::receiver_1 rcv;
        pika::execution::experimental::set_value(std::move(rcv), 1);
    ...
    {
        mylib::receiver_2 rcv;
        pika::execution::experimental::set_error(std::move(rcv), 1);
        PIKA_TEST(error_called);
        error_called = false;
    }
