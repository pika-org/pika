...
#define PIKA_ANY_OPERATION_STATE_SBO_SIZE 1
#endif

#if !defined(PIKA_ANY_RECEIVER_SBO_SIZE)
#define PIKA_ANY_RECEIVER_SBO_SIZE 1
#endif

#if !defined(PIKA_UNIQUE_ANY_SENDER_SBO_SIZE)
#define PIKA_UNIQUE_ANY_SENDER_SBO_SIZE 1
#endif

#if !defined(PIKA_ANY_SENDER_SBO_SIZE)
#define PIKA_ANY_SENDER_SBO_SIZE 1
#endif
