...
namespace pika::execution::experimental::detail {
    ...
    PIKA_NORETURN PIKA_EXPORT void throw_bad_any_call(
    ...
    struct empty_any_receiver final : any_receiver_base<Ts...>
    {
        ...
        PIKA_NORETURN void set_error(std::exception_ptr) && noexcept override
        {
...
namespace pika::execution::experimental::detail {
    ...
    struct empty_unique_any_sender final : unique_any_sender_base<Ts...>
    {
        ...
        PIKA_NORETURN any_operation_state connect(any_receiver<Ts...>&&) &&
            override
        {
