...
namespace pika { namespace util {
    ...
    PIKA_EXPORT void set_enable_parent_task_handler(
        enable_parent_task_handler_type f);

    namespace external_timer {

        // pika provides a smart pointer to a data object that maintains
        // information about an pika_thread. Any library (i.e. APEX) that wants
        ...
        // outside of the pika library.
        PIKA_EXPORT extern init_t* init_function;
        PIKA_EXPORT extern finalize_t* finalize_function;
        PIKA_EXPORT extern register_thread_t* register_thread_function;
        PIKA_EXPORT extern new_task_string_t* new_task_string_function;
        PIKA_EXPORT extern new_task_address_t* new_task_address_function;
        ...
        PIKA_EXPORT void register_external_timer(
        ...
        PIKA_EXPORT inline std::shared_ptr<task_wrapper> update_task(
