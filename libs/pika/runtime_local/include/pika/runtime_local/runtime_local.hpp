...
#include <pika/runtime_local/thread_mapper.hpp>
...
namespace pika {
    ...
    public:
        ...
        ///        runtime.
        virtual pika::threads::threadmanager& get_thread_manager();
    ...
    protected:
        ...
        std::unique_ptr<pika::threads::threadmanager> thread_manager_;
