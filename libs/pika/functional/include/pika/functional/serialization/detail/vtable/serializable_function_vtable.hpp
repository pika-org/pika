...
#include <pika/functional/serialization/detail/vtable/serializable_vtable.hpp>
...
namespace pika { namespace util { namespace detail {
    ...
    struct serializable_function_vtable : serializable_vtable
    {
        ...
        {
            pika::serialization::detail::polymorphic_intrusive_factory::
                instance()
                    .register_class(
        ...
        std::string const& name)
    {
        ...
        return pika::serialization::detail::polymorphic_intrusive_factory::
            instance()
