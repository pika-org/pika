...
int main()
{
    ...
    PIKA_TEST_EQ(
        &pika::util::protect(pika::util::bind(g, placeholders::_1))(i[0]),
        &i[0]);
    ...
    PIKA_TEST_EQ(
        pika::util::protect(pika::util::bind(f, placeholders::_1))(0), 0);
    ...
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_1)))(0, 1, 2, 3, 4, 5, 6),
        0);
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_2)))(0, 1, 2, 3, 4, 5, 6),
        1);
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_3)))(0, 1, 2, 3, 4, 5, 6),
        2);
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_4)))(0, 1, 2, 3, 4, 5, 6),
        3);
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_5)))(0, 1, 2, 3, 4, 5, 6),
        4);
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_6)))(0, 1, 2, 3, 4, 5, 6),
        5);
    PIKA_TEST_EQ(constify(pika::util::protect(pika::util::bind(
                     f, placeholders::_7)))(0, 1, 2, 3, 4, 5, 6),
        6);
