...
namespace pika::threads {
    ...
    std::int64_t get_idle_core_count() { return get_runtime().get_thread_manager().get_idle_core_count(); }

    detail::mask_type get_idle_core_mask() { return get_runtime().get_thread_manager().get_idle_core_mask(); }
