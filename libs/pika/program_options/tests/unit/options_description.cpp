...
void test_approximation()
{
    ...
    PIKA_TEST_EQ(desc.find("fo", true).long_name(), "foo");

    PIKA_TEST_EQ(desc.find("all", true).long_name(), "all");
    PIKA_TEST_EQ(desc.find("all-ch", true).long_name(), "all-chroots");
    ...
    PIKA_TEST_EQ(desc2.find("config", true).long_name(), "config");
    PIKA_TEST_EQ(desc2.find("config-value", true).long_name(), "config-value");
}
...
void test_approximation_with_multiname_options()
{
    ...
    PIKA_TEST_EQ(desc.find("fo", true).long_name(), "qux");
...
void test_multiname_option_formatting()
{
    ...
    stringstream ss;
    ss << desc;
    PIKA_TEST_EQ(ss.str(), "  --foo arg             a multiple-name option\n");
}
